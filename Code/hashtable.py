...
class HashTable(object):
    ...
    def load_factor(self):
        ...
        Best and worst case running time: O(1) because functions are constant
        """
        return float(self.size) / float(len(self.buckets))

    def keys(self):
        """Return a list of all keys in this hash table.
        Best and worst case running time: O(n), looping over each item once
        """
    ...
    def length(self):
        ...
        Best and worst case running time: O(n) because it loops over all nodes
        """
    ...
    def _resize(self, new_size=None):
        ...
        Best and worst case running time: O(n) as it loops through all items
            twice (technically 2n, but it simplifies)
        Best and worst case space usage: All the k-v pairs in the table are
            copied then overwritten and replaced in the table
        """
